...
from models.baseline_UNETR3D import UNETR as Base_UNETR

VERBOSE = False
#VERBOSE = True

class UNetR_Lightning(pl.LightningModule):
    def __init__(self, UNet_params: dict, params: dict,
                 **kwargs):
        super(UNetR_Lightning, self).__init__()

        self.in_channels = params['in_channels']
        self.start_filts = params['init_filter_size']
        self.dropout_rate = params['dropout_rate']
        self.model = Base_UNETR(
